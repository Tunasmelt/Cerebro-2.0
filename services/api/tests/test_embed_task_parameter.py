...
JinaEmbedClient/CohereEmbedClient HTTP call shape against a fake
transport, proving the right task/input_type reaches the request body
for both the ingest (passage) and query paths — not just that a fake
in-memory EmbedClient accepts the new parameter.
"""
import json
...
from app.ingest.embed import CohereEmbedClient, JinaEmbedClient
